...
def create_api_key(
    ...
    创建 API 密钥
    """
    return ApiKeyService.create_api_key(db=db, api_key_in=api_key_in, user_id=user_id)
...
def update_api_key(
    ...
    更新 API 密钥
    """
    return ApiKeyService.update_api_key(db=db, api_key_in=api_key_in, user_id=user_id)
...
def delete_api_key(
    ...
    """
    return ApiKeyService.delete_api_key(db=db, id=id, user_id=user_id)
...
def restore_api_key(
    ...
    """
    return ApiKeyService.restore_api_key(db=db, id=id, user_id=user_id)
...
def get_api_key(
    ...
    获取单个 API 密钥
    """
    return ApiKeyService.get_api_key(db=db, id=id, user_id=user_id)
...
def get_simple_list(
    ...
    获取简单 API 密钥列表
    """
    return ApiKeyService.get_api_keys_by_status(db=db, status=status, user_id=user_id)
...
def get_api_key_page(
    ...
    获取 API 密钥分页列表
    """
    return ApiKeyService.get_api_key_page(db=db, page=page, user_id=user_id)
